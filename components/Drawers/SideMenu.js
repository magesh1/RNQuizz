	...
	return (
		<View style={{ flex: 1 }}>
			<DrawerContentScrollView {...props}>
				<View style={styles.userInfoSection}>
					<View style={{ flexDirection: "row", marginTop: 15 }}>
						{/* <Avatar.Image source={require("../images/123.jpg")} size={50} /> */}
				...
				<Drawer.Section>
					<DrawerItem
						icon={() => (
							<Icon name="home-outline" style={{ fontSize: 2.8 * vh, color: "grey" }} />
						)}
						label="Home"
						onPress={() => {
					...
					<DrawerItem
						icon={() => (
							<Icon name="wallet-outline" style={{ fontSize: 2.8 * vh, color: "grey" }} />
						)}
						label="Wallet"
						onPress={() => {
			...
			<Drawer.Section style={styles.bottomDrawerSection}>
				<DrawerItem
					icon={() => (
						<Icon name="exit-to-app" style={{ fontSize: 2.8 * vh, color: "grey" }} />
					)}
					label="Sign Out"
					onPress={() => {
						signOut()
